...
class Cuztom_Initializer{
	...
	private function includes(){
		...
		include( CUZTOM_DIR . 'classes/meta/options.class.php' );
		...
		include( CUZTOM_DIR . 'classes/fields/gmap.class.php' );
		include( CUZTOM_DIR . 'classes/fields/number.class.php' );
		include( CUZTOM_DIR . 'classes/fields/readonly.class.php' );
		include( CUZTOM_DIR . 'classes/fields/shortcode.class.php' );
		include( CUZTOM_DIR . 'classes/fields/hours.class.php' );
		include( CUZTOM_DIR . 'classes/fields/text_check.class.php' );
		include( CUZTOM_DIR . 'classes/fields/encrypted_text.class.php' );
		include( CUZTOM_DIR . 'classes/fields/encrypted_textarea.class.php' );
		include( CUZTOM_DIR . 'classes/fields/encrypted_select.class.php' );
		include( CUZTOM_DIR . 'classes/fields/encrypted_radios.class.php' );
		include( CUZTOM_DIR . 'classes/fields/encrypted_checkboxes.class.php' );
	...
	function register_styles(){
		wp_register_style( 'cuztom-jquery-ui', '//code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css', false, CUZTOM_VERSION, 'screen' );
